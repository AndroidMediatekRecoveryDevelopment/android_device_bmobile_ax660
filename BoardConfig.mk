...
-include vendor/bmobile/AX660/BoardConfigVendor.mk
...
TARGET_BOOTLOADER_BOARD_NAME := AX660
...
BOARD_CUSTOM_BOOTIMG_MK := device/bmobile/AX660/bootimg.mk
BOARD_MKBOOTIMG_ARGS := --mtk 1

TARGET_PREBUILT_KERNEL := device/bmobile/AX660/prebuilt/kernel
TARGET_RECOVERY_INITRC := device/bmobile/AX660/recovery/init.mt6572.rc
TARGET_RECOVERY_FSTAB := device/bmobile/AX660/recovery/recovery.fstab
...
TARGET_COMMON_NAME := bmobile AX660
